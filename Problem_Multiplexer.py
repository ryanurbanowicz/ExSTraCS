...
Address Bits = 2 (6-Multiplexer) - 8 optimal rules
Address Bits = 3 (11-Multiplexer) -  18 optimal rules
Address Bits = 4 (20-Multiplexer)  - 32 optimal rules
...
#generate_mulitplexer_data("Multiplexer_Data.txt", 37, 1000)
